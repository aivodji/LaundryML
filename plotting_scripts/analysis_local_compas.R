...
df_bbox <- read.csv("data/bbox_unfairness_compas.csv", header=T)
df      <- read.csv("data/badml_unfairness_compas.csv", header=T)
...
ggsave("graphs/local_compas.pdf", dpi=300, width=4.5, height=3)
